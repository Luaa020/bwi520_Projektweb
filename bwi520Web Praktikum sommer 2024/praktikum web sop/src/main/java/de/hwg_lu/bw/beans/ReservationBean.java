...
public class ReservationBean {
	...
	// mail senden
     ...
     String sujet = "Reservirungsbest�tigung";
...
//	// pour les testes du programme..
	...
	public void createReservation() {
		...
		confirmReservationSendMail("Best�tigung Ihrer Reservierung");
		 zaehler++;
	}
	public void confirmReservationSendMail(String subjet) {
		...
		es.setBodyMail("Sehr geehrte Damen und Herren,\r\n"
				+ "\r\n"
				+ "wir freuen uns, Ihre Reservierung im Restaurant KamerDelices zu best�tigen. Die Details Ihrer Reservierung lauten wie folgt:\r\n"
				+ "\r\n"
				...
				+ "\r\n"
				+ "Wir haben auch Ihre speziellen W�nsche ber�cksichtigt:\r\n"
				+ "\r\n"
				+ ""+ reservZeiger.getMessage()+"\r\n"
				+ "\r\n"
				+ "Wir bedanken uns f�r Ihr Vertrauen und freuen uns darauf, Sie in unserem Restaurant begr��en zu d�rfen.\r\n"
				+ "\r\n"
	...
	public void modificationReservation() {
		...
		for (Reservation reservationModif : reservations) {
			...
			if ((reservationModif.getId()==modifAnnullID)){
				...
				confirmReservationSendMail("�nderungsbest�tigung Ihrer Reservierung");
			}	}	
	}
	...
	public String getResultNotFound(){
		if (SuchUndfound==2) {
			...
			return "Desol�, accune reservation n a �t� trouv�e";
		}
		return"";
