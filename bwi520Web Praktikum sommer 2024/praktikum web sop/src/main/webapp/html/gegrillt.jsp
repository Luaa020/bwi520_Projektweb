...
<jsp:getProperty property="headerAsHtml" name="CodeAShtml"/>
 <!-- Lien vers la page du menu -->
   <div class="container">
           <div class="dish-list">
            <div class="dish">
                <img src="../img/mouton braisé.jpg" alt="Steak">
                <div class="dish-info">
                    <h2 class="dish-name">Gegrilltes Steak</h2>
                    <p class="dish-ingredients">Hauptzutaten: Rindersteak, Gewürze</p><br>
                    <p class="dish-price">Preis: &euro;15.99</p>
                </div>
            </div>
            <div class="dish">
                <img src="../img/poulet braise.jpeg" alt="Hähnchen">
                <div class="dish-info">
                    <h2 class="dish-name">Gegrilltes Hähnchen</h2>
                    <p class="dish-ingredients">Hauptzutaten: Hähnchenbrust, Marinade</p><br>
            ...
            <div class="dish">
                <img src="../img/menu2.jpg" alt="Hähnchen">
                <div class="dish-info">
            ...
            <div class="dish">
                ...
                <div class="dish-info">
                    ...
                    <p class="dish-ingredients">Hauptzutaten: SchweinenKotelleten, Gewürze, Marinade</p><br>
                    <p class="dish-price">Preis: &euro;15.99</p>
                </div>
            </div>
            <div class="dish">
                <img src="../img/poisson.jpg" alt="Hähnchen">
                <div class="dish-info">
